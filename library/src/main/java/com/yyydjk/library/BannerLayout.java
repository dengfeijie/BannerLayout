    ...
    private class LoopPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            if (views.size() > 0) {
                ...
                int tp = position % BannerLayout.this.itemCount - 1;
                if (tp < 0) {
                    tp = BannerLayout.this.itemCount - 1;
                }
                ...
                if (BannerLayout.this.onBannerSwitchListener != null) {
                    BannerLayout.this.onBannerSwitchListener.onSwitch(tp);
                }
